...
<html lang ="en">
    <head>
        ...
        <link href="/cos10026/s103606281/assign2/style.css" rel="stylesheet">
    ...
    <body>
       ...
       $errors = [];
       session_start();
       $jobreferenceNumber = $firstname = $lastname = $dob = $gender = $streetaddress = $suburb = $state = $postcode = $email = $phoneNumber = $EssentialSkill = $PreferredSkill = $otherskills = "";
       ...
       if ($_SERVER['REQUEST_METHOD'] !== 'POST') {
           header('Location: sales_apply.php'); 
           exit;
       }
    ...
    // Redirect back to the form
    header("Location: sales_apply.php"); // Adjust if necessary to your form's URL
    exit();
    }
        ?>
    </body>
