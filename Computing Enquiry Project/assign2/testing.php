...
if (isset($_POST['delete_submit'])) {
    ...
    if ($result) {
        ...
        echo "<p class='error-msg'>Failed to delete the record. Please check the job reference number and try again.</p>";
    }
}
?>
<?php
...
if (isset($_POST["eoiNumber"]) || isset($_POST["job_reference"]) || isset($_POST["first_name"]) || isset($_POST["last_name"])) {
    echo '<h1 class="search-results-title">Search Results</h1>';
